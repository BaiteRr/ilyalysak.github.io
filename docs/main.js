...
/* harmony import */ var _js_slick_min__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/slick.min */ "./js/slick.min.js");
...
jquery__WEBPACK_IMPORTED_MODULE_4___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_4___default()('.slider').slick({
    arrows: true,
    dots: true
  });
});
